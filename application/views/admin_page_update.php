...
var editor;
$(function() {
    $('.menu-page-create').addClass('curr');
    ...
    $('#submitform').click(function() {
        ...
        <div class="col-sm-10 fx-main">
            ...
            <form id="pageform" method="post" action="<?php echo admin_site_url('page/update_action'); ?>">
            <table border="0" cellpadding="0" cellspacing="0" class="form">
                <tr>
                    <th width="100px">页面名称</th>
                    <td widht="*" id="article">
                        <input type="text" id="name" name="name" class="input-item-text" maxlength="64" placeholder="页面名称，比如“关于我们”" title="页面名称" style="width:280px; margin:0 7px 3px 0" value="<?php echo $page->name; ?>" />
                        <input type="text" id="link" name="link" class="input-item-text" maxlength="64" placeholder="页面链接，比如“about”" title="页面名称" style="width:180px; margin:0 7px 3px 0" value="<?php echo $page->link; ?>" />
                        <a href="javascript:;" style="margin-left:6px" onClick="showOptionBox(this)">页面选项 »</a>
                        <div class="option-multi-item">
                            <input type="text" id="sort" name="sort" class="input-item-text" maxlength="3" placeholder="页面显示顺序" title="页面显示顺序" value="<?php echo $page->sort; ?>" />
                            <p class="tips">该页面在相应位的显示顺序，该项只能是数字并且最大不能超过 255</p>
                            
                            <input type="text" id="keyword" name="keyword" class="input-item-text" maxlength="120" placeholder="页面关键字" title="页面关键字" value="<?php echo $page->keyword; ?>" />
                            <p class="tips">该页面的关键字（keywords），用空格分隔，长度不要超过 80 个字符</p>
                            
                            <textarea rows="3" type="text" id="description" name="description" class="input-item-text" style="line-height:18px;overflow:hidden;resize:none" maxlength="120" placeholder="页面描述" title="页面描述"><?php echo $page->description; ?></textarea>
                ...
                <tr>
                    <th>页面内容</th>
                    <td>
                        <script type="text/plain" id="content" name="content" ><?php echo htmlspecialchars_decode($page->content); ?></script>
                        <div id="attach">
                            <?php
                ...
                <tr>
                    <th>&nbsp;<input type="hidden" name="pid" value="<?php echo $page->pid; ?>" /></th>
                    <td>
                        <input type="button" value="保存页面" id="submitform" class="input-item-submit" />&nbsp;&nbsp;
