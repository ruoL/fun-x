        ...
        <div id="container">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="form">
                <tr>
                    ...
                    <td widht="*" id="article">
                        ...
                        <div class="option-multi-item">
                            <input type="text" id="fromurl" name="fromurl" class="input-item-text" placeholder="文章来源地址" title="文章来源地址" value="<?php echo $huangye->from; ?>" />
                ...
                <tr>
                    <th>内容</th>
                    <td>
                        <script type="text/plain" id="content" name="content" ><?php echo htmlspecialchars_decode($huangye->content); ?></script>
                        <div id="attach">
                            <?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" id="draftid" name="draftid" value="<?php echo $huangye->hid; ?>" />
