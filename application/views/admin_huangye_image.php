...
<script type="text/javascript" src="<?php echo base_url('minify/?b=static/scripts&f=jquery.min.js,jquery.dialog.js,jquery.select.js,jquery.crop.js,admincp.js'); ?>"></script>
...
$(function() {
    ...
    $(image).load(function() {
        ...
        var html  = '<img src="' + path + '?' + Math.random() + '" id="crop-image" />';
            html += '<input type="hidden" id="aid" name="hid" value="' + aid + '" />';
...
<body>
<form id="cropimage" method="post" action="<?php echo admin_site_url('huangye/crop_image_action'); ?>"></form>
</body>
</html>