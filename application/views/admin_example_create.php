...
<div class="col-sm-10 fx-main">
  <form id="exampleform" method="post" action="<?php echo admin_site_url('example/createAction'); ?>" enctype="multipart/form-data">
    <table border="0" cellpadding="0" cellspacing="0" class="form">
      <tr>
        ...
        <tr>
            <th>分类标签</th>
            <td>
                <input type="text" id="tag" name="tag[]" class="form-group-sm form-control" maxlength="64" style="margin:0 7px 3px 0;width: 500px;" />
        ...
        <tr>
            <th>案例摘要</th>
            <td>
            <textarea rows="2" type="text" id="zhaiyao" name="zhaiyao" class="form-control" style="line-height:18px;overflow:hidden;resize:none" maxlength="120" placeholder="案例摘要" title="案例摘要"></textarea>
            </td>
        </tr>
        <tr>
            <th>案例简介</th>
            <td>
            <textarea rows="3" type="text" id="jianjie" name="jianjie" class="form-control" style="line-height:18px;overflow:hidden;resize:none" maxlength="200" placeholder="案例简介(最多200字数)" title="案例简介"></textarea>
            </td>
        </tr>
        <tr>
            <th>色系值</th>
